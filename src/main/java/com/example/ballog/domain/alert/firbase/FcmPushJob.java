...
public class FcmPushJob implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        OAuthToken fcmToken = oAuthTokenRepository.findByUserAndProvider(user, "fcm").orElse(null);
        if (fcmToken == null || fcmToken.getAccessToken() == null) return;
        ...
        FcmMessageRequest request = new FcmMessageRequest(fcmToken.getAccessToken(), notification);
